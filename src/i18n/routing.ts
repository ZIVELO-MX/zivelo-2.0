...
export const routing = defineRouting({
  ...
  pathnames: {
    ...
    "/admin/posts": { es: "/admin/posts", en: "/admin/posts" },
    "/admin/posts/new": { es: "/admin/posts/nuevo", en: "/admin/posts/new" },
    "/admin/posts/[id]/edit": { es: "/admin/posts/[id]/editar", en: "/admin/posts/[id]/edit" },
    "/login": "/login",
  },
});
