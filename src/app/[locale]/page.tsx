          ...
          <Reveal className="services__grid">
            <article className="service service--featured">
              ...
              <div>
                ...
                <div style={{ marginTop: 26 }}><Link className="tlink" href="/services#web">{t("learnMore")} <span className="arrow">→</span></Link></div>
              </div>
            </article>
            <article className="service">
              ...
              <div style={{ marginTop: 26 }}><Link className="tlink" href="/services#restaurant">{t("learnMore")} <span className="arrow">→</span></Link></div>
            </article>
            <article className="service">
              ...
              <div style={{ marginTop: 26 }}><Link className="tlink" href="/services#pos">{t("learnMore")} <span className="arrow">→</span></Link></div>
            </article>
          </Reveal>
        </div>
      </section>
